...
public class GeneralizationBtn extends Button{
	...
	public void actionPerformed(ActionEvent e) {
		...
		_canvas.unSelectAll();
		changeMode(new GeneralizationMode(_canvas));
	}
}
